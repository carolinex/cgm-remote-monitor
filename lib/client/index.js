...
client.load = function load (serverSettings, callback) {
  ...
  client.focusRangeMS = times.hours(12).msecs;
  ...
  function brushed () {
    ...
    $('#chartContainer').css({top: 'auto', height: $(window).height() - top - 10 });//top: 'auto', height: ($(window).height()*0.85) - top - 10
