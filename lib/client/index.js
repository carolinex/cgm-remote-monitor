...
client.load = function load (serverSettings, callback) {
  ...
  function brushed () {
    ...
    $('#chartContainer').css({top: 'auto', height: ($(window).height()*0.75) - top - 10 });//top: 'auto', height: ($(window).height()*0.85) - top - 10
  ...
  function prepareEntries () {
    ...
    client.entries = client.entries.concat(client.ddata.mbgs.map(function(obj) {
      return { mills: obj.mills, mgdl: obj.mgdl, color: '#E04445', type: 'mbg', device: obj.device };
    }));
